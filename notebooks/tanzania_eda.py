"""
Tanzania Climate Data Analysis
...
print("=" * 60)
print("TANZANIA CLIMATE DATA ANALYSIS")
print("=" * 60)
...
try:
    ...
    print("ERROR: data/tanzania.csv not found")
    sys.exit(1)
...
print(f"   Saved cleaned data to data/tanzania_clean.csv")
...
plt.tight_layout()
plt.savefig('tanzania_temperature.png')
print("   Saved: tanzania_temperature.png")

print("\n" + "=" * 60)
print("TANZANIA ANALYSIS COMPLETE")
print("=" * 60)