...
print("=" * 60)
print("NIGERIA CLIMATE DATA ANALYSIS")
print("=" * 60)
...
try:
    ...
    print("ERROR: data/nigeria.csv not found")
    sys.exit(1)
...
print(f"   Saved cleaned data to data/nigeria_clean.csv")
...
plt.tight_layout()
plt.savefig('nigeria_temperature.png')
print("   Saved: nigeria_temperature.png")

print("\n" + "=" * 60)
print("NIGERIA ANALYSIS COMPLETE")
print("=" * 60)